    ...
    return ( 
            ...
            <div className="register__card">
                ...
                <div className="fname__input__container reg__input__container">
                        ...
                        <input type="text" className="fname__input register__input" value={username}
                    ...
                    <div className="password__input__container reg__input__container">
                        ...
                        <input type="password" className="password__input register__input" value={password}
                    onChange={e => setPassword(e.target.value)}
                    />
                    </div>
                    <div className="password__input__container reg__input__container">
                        <label className="password__label input__label">Age</label>
                        <input type="number" className="password__input register__input" value={age}
                    onChange={e => setAge(e.target.value)}
                    />
                    </div>
                    <div className="password__input__container reg__input__container">
                        <label className="password__label input__label">Gender</label>
                        <input type="text" className="password__input register__input" value={gender}
